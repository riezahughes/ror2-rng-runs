...
const App = () => {
  ...
  const rngTime = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_URL}/roll`, {
        action: "roll",
        filters: {
  ...
  return (
    <div>
      ...
      />
      <div className="mainContainer" onMouseMove={updateTooltipPosition}>
        {/* <h3>RNG Limits:</h3>
        <Grid
        container
        spacing={0}
        ...
        <h2>Characters in Pool:</h2>
        <Grid container spacing={0} alignItems="center" justify="center">
          <Grid item xs={0}>
            <CharacterPortrait
              name="commando"
              image={CommandoPortrait}
              value="commando"
              key={filteredCharacters.commando}
              filtered={filteredCharacters.commando}
              setFilter={changeCharacterFilter}
            />
          </Grid>
          <Grid item xs={0}>
            <CharacterPortrait
              name="huntress"
              image={HuntressPortrait}
              value="huntress"
              key={filteredCharacters.huntress}
              filtered={filteredCharacters.huntress}
              setFilter={changeCharacterFilter}
            />
          </Grid>
          <Grid item xs={0}>
            <CharacterPortrait
              name="bandit"
              image={BanditPortrait}
              value="bandit"
              key={filteredCharacters.bandit}
              filtered={filteredCharacters.bandit}
              setFilter={changeCharacterFilter}
            />
          </Grid>
          <Grid item xs={0}>
            <CharacterPortrait
              ...
              image={MultiPortrait}
              value="mult"
              key={filteredCharacters.mult}
              filtered={filteredCharacters.mult}
              setFilter={changeCharacterFilter}
            />
          </Grid>
          <Grid item xs={0}>
            <CharacterPortrait
              name="engineer"
              image={EngineerPortrait}
              value="engineer"
              key={filteredCharacters.engineer}
              filtered={filteredCharacters.engineer}
              setFilter={changeCharacterFilter}
            />
          </Grid>
          <Grid item xs={0}>
            <CharacterPortrait
              name="artificer"
              image={ArtificerPortrait}
              value="artificer"
              key={filteredCharacters.artificer}
              filtered={filteredCharacters.artificer}
              setFilter={changeCharacterFilter}
            />
          </Grid>
          <Grid item xs={0}>
            <CharacterPortrait
              name="mercenary"
              image={MercenaryPortrait}
              value="mercenary"
              key={filteredCharacters.mercenary}
              filtered={filteredCharacters.mercenary}
              setFilter={changeCharacterFilter}
            />
          </Grid>
          <Grid item xs={0}>
            <CharacterPortrait
              ...
              image={RexPortrait}
              value="rex"
              key={filteredCharacters.rex}
              filtered={filteredCharacters.rex}
              setFilter={changeCharacterFilter}
            />
          </Grid>
          <Grid item xs={0}>
            <CharacterPortrait
              name="loader"
              image={LoaderPortrait}
              value="loader"
              key={filteredCharacters.loader}
              filtered={filteredCharacters.loader}
              setFilter={changeCharacterFilter}
            />
          </Grid>
          <Grid item xs={0}>
            <CharacterPortrait
              ...
              image={AcridPortrait}
              value="acrid"
              key={filteredCharacters.acrid}
              filtered={filteredCharacters.acrid}
              setFilter={changeCharacterFilter}
            />
          </Grid>
          <Grid item xs={0}>
            <CharacterPortrait
              ...
              value="captain"
              key={filteredCharacters.captain}
              filtered={filteredCharacters.captain}
              setFilter={changeCharacterFilter}
            />
          </Grid>
        </Grid>
        <h2>Artifacts in Pool:</h2>
          ...
          <Grid container spacing={1} alignItems="center" justify="center">
            <Grid item xs={0}>
              <ArtifactPortrait
                image={ChaosPortrait}
                value="chaos"
                filtered={filteredArtifacts.chaos}
                setFilter={changeArtifactFilter}
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={CommandPortrait}
                value="command"
                filtered={filteredArtifacts.command}
                setFilter={changeArtifactFilter}
                title="Artifact of Command"
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={DeathPortrait}
                value="death"
                filtered={filteredArtifacts.death}
                setFilter={changeArtifactFilter}
                title="Artifact of Death"
                description="When one player dies, everyone died. Enable only if you want to truly put your teamwork and individual skill to the ultimate test,"
                mouseIn={showTooltip}
                mouseOut={hideTooltip}
              />
            </Grid>
            <Grid item xs={0}>
              <ArtifactPortrait
                image={DissonancePortrait}
                value="dissonance"
                filtered={filteredArtifacts.dissonance}
                setFilter={changeArtifactFilter}
                title="Artifact of Dissonance"
                description="Monsters can appear outside of their usual environments."
                mouseIn={showTooltip}
                mouseOut={hideTooltip}
              />
            </Grid>
            <Grid item xs={0}>
              <ArtifactPortrait
                image={EnigmaPortrait}
                value="enigma"
                filtered={filteredArtifacts.enigma}
                setFilter={changeArtifactFilter}
                title="Artifact of Enigma"
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={EvolutionPortrait}
                value="evolution"
                filtered={filteredArtifacts.evolution}
                setFilter={changeArtifactFilter}
                title="Artifact of Evolution"
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={FrailtyPortrait}
                value="frailty"
                filtered={filteredArtifacts.frailty}
                setFilter={changeArtifactFilter}
                title="Artifact of Frailty"
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={GlassPortrait}
                value="glass"
                filtered={filteredArtifacts.glass}
                setFilter={changeArtifactFilter}
                title="Artifact of Glass"
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={HonorPortrait}
                value="honor"
                filtered={filteredArtifacts.honor}
                setFilter={changeArtifactFilter}
                title="Artifact of Honor"
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={KinPortrait}
                value="kin"
                filtered={filteredArtifacts.kin}
                setFilter={changeArtifactFilter}
                title="Artifact of Kin"
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={MetamorphosisPortrait}
                value="metamorphosis"
                filtered={filteredArtifacts.metamorphosis}
                setFilter={changeArtifactFilter}
                title="Artifact of Metamorphosis"
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={SacrificePortrait}
                value="sacrifice"
                filtered={filteredArtifacts.sacrifice}
                setFilter={changeArtifactFilter}
                title="Artifact of Sacrifice"
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={SoulPortrait}
                value="soul"
                filtered={filteredArtifacts.soul}
                setFilter={changeArtifactFilter}
                title="Artifact of Soul"
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={SpitePortrait}
                value="spite"
                filtered={filteredArtifacts.spite}
                setFilter={changeArtifactFilter}
                title="Artifact of Spite"
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={SwarmsPortrait}
                value="swarms"
                filtered={filteredArtifacts.swarms}
                setFilter={changeArtifactFilter}
                title="Artifact of Swarms"
            ...
            <Grid item xs={0}>
              <ArtifactPortrait
                image={VengeancePortrait}
                value="vengeance"
                filtered={filteredArtifacts.vengeance}
                setFilter={changeArtifactFilter}
                title="Artifact of Vengeance"
